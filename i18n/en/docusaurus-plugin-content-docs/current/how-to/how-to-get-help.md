...
2. When clicking the help button, the user will see the support options offered for Gita:
    > ![image](/images/image020.png)
    >
    > ***Image 02: Dialog - Cluster assistance***
3. Clicking on the second option "Docs" will take the user to the platform documentation, available at [doc.gita.cloud](https://doc.gita.cloud/).
    > ![image](/images/image022.png)
    >
    > ***Image 03: Screen - Official documentation***
